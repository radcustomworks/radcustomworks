...
class Businesstar_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="businesstar-chosen-select" <?php $this->link(); ?>>
                    <?php
...
Class Businesstar_Customize_Horizontal_Line extends WP_Customize_Control {
    public $type = 'hr';
...
class Businesstar_Multi_Input_Custom_Control extends WP_Customize_Control {
    /**
     * Control type
     *
     * @var string
...
class Businesstar_Note_Control extends WP_Customize_Control {
