...
*/
 jQuery(document).ready(function($) {
    // $('#businesstar-img-container li label img').click(function(){    	
    //     $('#businesstar-img-container li').each(function(){
    //         $(this).find('img').removeClass ('businesstar-radio-img-selected') ;
    //     });
    //     $(this).addClass ('businesstar-radio-img-selected') ;
    // }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', businesstar_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', businesstar_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', businesstar_customize_multi_remove_field )
    ...
    $('#customize-control-theme_options-layout_options_blog #businesstar-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_blog #businesstar-img-container li').each(function(){
            $(this).find('img').removeClass ('businesstar-radio-img-selected') ;
        });
        $(this).addClass ('businesstar-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #businesstar-img-container li label img').click(function(){       
        $('#customize-control-theme_options-layout_options_archive #businesstar-img-container li').each(function(){
            $(this).find('img').removeClass ('businesstar-radio-img-selected') ;
        });
        $(this).addClass ('businesstar-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #businesstar-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_page #businesstar-img-container li').each(function(){
            $(this).find('img').removeClass ('businesstar-radio-img-selected') ;
        });
        $(this).addClass ('businesstar-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #businesstar-img-container li label img').click(function(){        
        $('#customize-control-theme_options-layout_options_single #businesstar-img-container li').each(function(){
            $(this).find('img').removeClass ('businesstar-radio-img-selected') ;
        });
        $(this).addClass ('businesstar-radio-img-selected') ;
    });    

    function businesstar_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            businesstar_customize_multi_write( $control );
    }

    function businesstar_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        businesstar_customize_multi_write( $control );
    }

    function businesstar_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function businesstar_customize_multi_write( $element) {
