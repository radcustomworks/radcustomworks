...
if( ! function_exists( 'businesstar_primary_navigation_fallback' ) ) :
	 ...
	 * @since 1.0.0
	 */
	function businesstar_primary_navigation_fallback() {
		
		echo '<ul>';
			echo '<li><a href="' . esc_url( home_url( '/' ) ) . '">' .esc_html__( 'Home', 'businesstar' ). '</a></li>';
			wp_list_pages( array(
			'title_li' => '',
			'depth'    => 1,
			'number'   => 5,
...
/**
 * Class businesstar_Dropdown_Taxonomies_Control
 */
class Businesstar_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        $dropdown = wp_dropdown_categories(
            array(
                'name'              => 'businesstar-dropdown-categories-' . $this->id,
                'echo'              => 0,
                'show_option_none'  => __( '&mdash; Select &mdash;', 'businesstar' ),
                'option_none_value' => '0',
                'selected'          => $this->value(),
                'hide_empty'        => 0,                   
...
class Businesstar_Switch_Control extends WP_Customize_Control{
    public $type = 'switch';
 ...
 */
class businesstar_Repeater_Text_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        ...
        <label class="repeater-text-input">
            ...
            <a href="#" class="button button-primary btn-add-field"><?php esc_html_e( 'Add New', 'businesstar' ) ?></a>
 ...
 * @access public
 */
class businesstar_Customize_Section_Upsell extends WP_Customize_Section {
